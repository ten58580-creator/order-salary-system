-- 1. Add Missing Columns for Timer & Status Tracking
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS production_time_seconds bigint DEFAULT 0;
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS last_started_at timestamptz;

-- 2. Recreate Production Summary Function (Now referencing existing columns)
...
-- 3. Update Status Function (Safe Loop Update)
